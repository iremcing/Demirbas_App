...
CREATE TABLE `personelyonetimi` (
  `ID` int NOT NULL,
  `personelAdi` varchar(20) NOT NULL,
  `personelSoyadi` varchar(20) NOT NULL,
  `personelSicilNumarasi` varchar(45) NOT NULL,
  `proje` varchar(100) NOT NULL,
...
INSERT INTO `personelyonetimi` VALUES (1,'irem','cing','4512367845897','demirbas','iremc9','2022-07-20');
