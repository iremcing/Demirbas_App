...
CREATE TABLE `zimmetvedusum` (
  `ID` int NOT NULL,
  `demirbasID` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `personelID` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `durum` int NOT NULL,
  `kullaniciAdi` varchar(30) NOT NULL,
  `date` date NOT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `zimmetVeDusumID_UNIQUE` (`ID`)
